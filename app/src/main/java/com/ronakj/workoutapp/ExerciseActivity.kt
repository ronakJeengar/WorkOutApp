...
import com.ronakj.workoutapp.databinding.ActivityExerciseBinding
import com.ronakj.workoutapp.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.ronakj.workoutapp/" + R.raw.press_start)
